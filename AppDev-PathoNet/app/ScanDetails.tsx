...
const getCategoryColor = (category: string) => {
  switch (category) {
    case "healthy":
      return { bg: "#E8F8E8", text: COLORS.primary, icon: "checkmark-circle" };
    case "fungal":
      return { bg: "#FFE8E8", text: "#E53935", icon: "warning" };
    case "bacterial":
      return { bg: "#FFF3E0", text: "#F57C00", icon: "warning" };
    case "viral":
      return { bg: "#F3E5F5", text: "#8E24AA", icon: "alert-circle" };
    case "pest":
      return { bg: "#E0F7FA", text: "#00838F", icon: "bug" };
    default:
      return { bg: "#F5F5F5", text: COLORS.textMid, icon: "help-circle" }
  }
};
